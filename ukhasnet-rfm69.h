 ...
 * Limited by the single message length octet in the header. 
 * Yes, 255 is correct even though the FIFO size in the RF22 is only
 * 64 octets. We use interrupts to refill the Tx FIFO during transmission 
 * and to empty theRx FIFO during reception
...
#define RF_LISTEN1_RESOL_4100                           0xA0
#define RF_LISTEN1_RESOL_262000                         0xF0

#define RF_LISTEN1_CRITERIA_RSSI                        0x00
#define RF_LISTEN1_CRITERIA_RSSIANDSYNC                 0x08

#define RF_LISTEN1_END_00                               0x00
#define RF_LISTEN1_END_01                               0x02
#define RF_LISTEN1_END_10                               0x04

/* RegListen2 */
#define RF_LISTEN2_COEFIDLE_VALUE                       0xF5

/* RegListen3 */
#define RF_LISTEN3_COEFRX_VALUE                         0x20
...
/* RegAgcRef */
#define RF_AGCREF_AUTO_ON                   0x40
#define RF_AGCREF_AUTO_OFF                  0x00

#define RF_AGCREF_LEVEL_MINUS80     0x00
...
#define RF_AGCTHRESH1_SNRMARGIN_101     0xA0
...
#define RF_AGCTHRESH1_STEP1_16              0x10
...
#define RF_AGCTHRESH2_STEP3_11              0x0B
...
#define RF_AGCTHRESH3_STEP4_9                   0x90
...
#define RF_AGCTHRESH3_STEP5_11              0x0B
...
#define RF_LNA_LOWPOWER_OFF                         0x00
...
#define RF_AFCBW_DCCFREQAFC_100             0x80
...
#define RF_OOKAVG_AVERAGETHRESHFILT_10      0x80
#define RF_OOKAVG_AVERAGETHRESHFILT_11      0xC0

/* RegOokFix */
#define RF_OOKFIX_FIXEDTHRESH_VALUE             0x06
...
#define RF_AFCFEI_AFCAUTOCLEAR_OFF                  0x00

#define RF_AFCFEI_AFCAUTO_ON                        0x04
#define RF_AFCFEI_AFCAUTO_OFF                       0x00
...
#define RF_RSSI_FASTRX_OFF                          0x00
...
/* RegRssiThresh */
#define RF_RSSITHRESH_VALUE                     0xE4

/* RegRxTimeout1 */
#define RF_RXTIMEOUT1_RXSTART_VALUE             0x00

/* RegRxTimeout2 */
#define RF_RXTIMEOUT2_RSSITHRESH_VALUE          0x00

/* RegPreamble */
#define RF_PREAMBLESIZE_MSB_VALUE               0x00
#define RF_PREAMBLESIZE_LSB_VALUE               0x03
...
/* RegSyncValue1-8 */
#define RF_SYNC_BYTE1_VALUE             0x00
#define RF_SYNC_BYTE2_VALUE             0x00
#define RF_SYNC_BYTE3_VALUE             0x00
#define RF_SYNC_BYTE4_VALUE             0x00
#define RF_SYNC_BYTE5_VALUE             0x00
#define RF_SYNC_BYTE6_VALUE             0x00
#define RF_SYNC_BYTE7_VALUE             0x00
#define RF_SYNC_BYTE8_VALUE             0x00
...
/* RegPayloadLength */
#define RF_PAYLOADLENGTH_VALUE                  0x40

/* RegBroadcastAdrs */
#define RF_BROADCASTADDRESS_VALUE               0x00

/* RegAutoModes */
#define RF_AUTOMODES_ENTER_OFF                    0x00
...
#define RF_AUTOMODES_EXIT_OFF                     0x00
...
#define RF_AUTOMODES_INTERMEDIATE_SLEEP           0x00
...
/* RegAesKey1-16 */
#define RF_AESKEY1_VALUE                        0x00
#define RF_AESKEY2_VALUE                        0x00
#define RF_AESKEY3_VALUE                        0x00
#define RF_AESKEY4_VALUE                        0x00
#define RF_AESKEY5_VALUE                        0x00
#define RF_AESKEY6_VALUE                        0x00
#define RF_AESKEY7_VALUE                        0x00
#define RF_AESKEY8_VALUE                        0x00
#define RF_AESKEY9_VALUE                        0x00
#define RF_AESKEY10_VALUE                       0x00
#define RF_AESKEY11_VALUE                       0x00
#define RF_AESKEY12_VALUE                       0x00
#define RF_AESKEY13_VALUE                       0x00
#define RF_AESKEY14_VALUE                       0x00
#define RF_AESKEY15_VALUE                       0x00
#define RF_AESKEY16_VALUE                       0x00

/* RegTemp1 */
#define RF_TEMP1_MEAS_START                     0x08
#define RF_TEMP1_MEAS_RUNNING                   0x04
#define RF_TEMP1_ADCLOWPOWER_ON                 0x01
#define RF_TEMP1_ADCLOWPOWER_OFF                0x00

/* RegTestDagc */
#define RF_DAGC_NORMAL                          0x00
